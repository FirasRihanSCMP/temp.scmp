...
const [errorFetchedChecker, seterrorFetchedChecker] = useState(false)
    useEffect(() => {
        async function fetchData() {
          await axios
            .get("http://188.166.60.231:3002/api/home")
            .then((response) => {
...
:<div><Spinner/></div>}
           ...
           {/*   <Eventcarousel img={["events/sws2020/concept2.jpg", "events/sws2020/second-approach.jpg", "accelerator1.jpg", "drill.jpg", "rocket.jpg", "food1.jpg", "photo1.jpg", "energycover.jpg", "energy1.jpg", "studies3.jpg"]} /> */}
